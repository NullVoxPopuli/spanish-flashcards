    ...
    <div class="home-container">
      ...
      <div class="quiz-modes">
        ...
        <div class="mode-buttons">
          <LinkTo @route="quiz" @model="english-to-spanish" class="mode-btn">
            <div class="mode-icon">🇺🇸 → 🇪🇸</div>
            <h3>English to Spanish</h3>
            <p>See the English word, recall the Spanish</p>
          </LinkTo>

          <LinkTo @route="quiz" @model="spanish-to-english" class="mode-btn">
            <div class="mode-icon">🇪🇸 → 🇺🇸</div>
            <h3>Spanish to English</h3>
            <p>See the Spanish word, recall the English</p>
          </LinkTo>

          <LinkTo @route="quiz" @model="random" class="mode-btn">
            <div class="mode-icon">🔀</div>
            <h3>Random</h3>
